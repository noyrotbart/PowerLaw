...
\subfloat[\small \textsc{google}]{
    \includegraphics[width=0.4\textwidth]{Figures/web-google-revised.pdf}
}\hspace*{-1.9em}
\subfloat[\small \textsc{youtube}]{
    \includegraphics[width=0.4\textwidth]{Figures/web-youtube-revised.pdf}
}%
\hfill
\subfloat[\small \textsc{wikitalk}]{
    \includegraphics[width=0.4\textwidth]{Figures/web-wikitalk-revised.pdf}
}\hspace*{-1.9em}
\subfloat[\small \textsc{livejournal}]{
    \includegraphics[width=0.4\textwidth]{Figures/web-livejournal-revised.pdf}
}%
