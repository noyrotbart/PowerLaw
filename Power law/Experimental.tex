...
For the dataset groups "Real-Life" and "Synthetic", the values of  ``Empirical'' and  ``Bound'' are sampled using simple concatenation of labels to represent the fat bit string for "Real-Life" and "Synthetic" , this incurs a $(\log n)/\alpha$ factor on the label size.
