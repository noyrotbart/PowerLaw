...
%deletions    We point out that this can be done easily in practice, by allowing re-labeling of fat nodes that become thin, or vice-versa. As such changes can be suppressed, it seems plausible that the label size can be maintained using very few acts of re-labeling.
...
Closing the  gap of the multiplicative logarithmic factor may be  of interest to the theory community.
