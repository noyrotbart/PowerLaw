...
Noy Rotbart.\\
       ...
       \affaddr{Universitetsparken 5,}\\
       \affaddr{Copenhagen, Denmark}\\
       \email{noyro@di.ku.dk}
% 3rd. author
\alignauthor Jakob Grue Simonsen\\
       \affaddr{DIKU}\\
       \affaddr{Universitetsparken 5,}\\
       \affaddr{Copenhagen, Denmark}\\
...
% 4th. author
\alignauthor Christian Wulff-Nilsen\\
       \affaddr{DIKU}\\
       \affaddr{Universitetsparken 5,}\\
       \affaddr{Copenhagen, Denmark}\\
       \email{koolooz@di.ku.dk}
}
...
We devise adjacency labeling schemes for  the family  of power-law graphs. This  family has been used to model many types of networks, e.g. the Internet AS-level graph. Furthermore, we  prove an almost matching  lower bound for this family.
